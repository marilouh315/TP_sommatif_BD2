...
# Form implementation generated from reading ui file 'hdvelh2.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1262, 860)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label_titreLivre = QtWidgets.QLabel(self.centralwidget)
        self.label_titreLivre.setGeometry(QtCore.QRect(470, 10, 771, 101))
        font = QtGui.QFont()
        ...
        self.label_nomGrand.setGeometry(QtCore.QRect(500, 120, 721, 41))
        font = QtGui.QFont()
        ...
        self.label_histoire.setGeometry(QtCore.QRect(560, 190, 191, 41))
        font = QtGui.QFont()
        ...
        self.label_histoireChapitre = QtWidgets.QLabel(self.groupBox_histoire)
        self.label_histoireChapitre.setGeometry(QtCore.QRect(540, 80, 231, 71))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.label_histoireChapitre.setFont(font)
        self.label_histoireChapitre.setAlignment(QtCore.Qt.AlignCenter)
        self.label_histoireChapitre.setObjectName("label_histoireChapitre")
        self.label_histoireChapitre_2 = QtWidgets.QLabel(self.groupBox_histoire)
        self.label_histoireChapitre_2.setGeometry(QtCore.QRect(540, 120, 231, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label_histoireChapitre_2.setFont(font)
        self.label_histoireChapitre_2.setText("")
        self.label_histoireChapitre_2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_histoireChapitre_2.setObjectName("label_histoireChapitre_2")
        ...
        self.listWidget_disciplines = QtWidgets.QListWidget(self.groupBox_disciplines)
        self.listWidget_disciplines.setGeometry(QtCore.QRect(20, 90, 391, 111))
        self.listWidget_disciplines.setObjectName("listWidget_disciplines")
        ...
        self.listWidget_armes = QtWidgets.QListWidget(self.groupBox_armes)
        self.listWidget_armes.setGeometry(QtCore.QRect(20, 80, 391, 51))
        self.listWidget_armes.setObjectName("listWidget_armes")
        ...
        self.spinBox_bourse_sac.setGeometry(QtCore.QRect(150, 370, 261, 31))
        ...
        self.label_condition_bourse = QtWidgets.QLabel(self.groupBox_sac)
        self.label_condition_bourse.setGeometry(QtCore.QRect(20, 380, 121, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.label_condition_bourse.setFont(font)
        self.label_condition_bourse.setObjectName("label_condition_bourse")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_histoireChapitre.setText(_translate("MainWindow", "Chapitre actuel : "))
        ...
        self.label_condition_bourse.setText(_translate("MainWindow", "50 pièces maximum"))
